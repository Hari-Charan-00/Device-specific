...
def update_resource(data):
    ...
    if token_response.status_code == 200:
        ...
        if access_token:
            ...
            api_endpoint = f'https://netenrich.opsramp.com/api/v2/tenants/{data["Client_ID"]}/resources/{data["uuid"]}'
...
input_file = 'C:\\Users\\hari.boddu\\Downloads\\resource_updation.xlsx'  # Update with your file path
